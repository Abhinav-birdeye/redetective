...
import { DIRECTORY, KEY_SIZE_FILENAME_TXT, SCAN_BATCH_SIZE } from "./utils/constants.js";
import { logger } from "./utils/logger.js";
import { byteSize, bytesToMB, ensureDirectoryExistence } from "./utils/helpers.js";
...
export async function scan() {
    ...
    async function batchProcess() {
        ...
        const result = getKeyResponse?.reduce(
            (accumulator, currentValue) => accumulator + byteSize(currentValue?.[1] as string),
            0,
        );
